...
import 'package:facebook_clone/features/chat/presentation/widgets/received_message_widget.dart';
...
class MessagesListWidget extends ConsumerWidget {
      ...
      data: (messages) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (isMyMessage) {
              return SentMessageWidget(message: message);
            } else {
